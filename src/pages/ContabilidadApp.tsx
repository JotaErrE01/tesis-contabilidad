...
export const ContabilidadApp = () => {
  ...
  return (
    <div className="h-screen">
      <h1
        className="lg:text-6xl text-orange-500 font-bold leading-normal m-0 ml-10 lg:mt-10 sm:fixed lg:w-4/5 md:text-5xl md:w-full md:mt-20 text-4xl pt-8 sm:pt-0"
