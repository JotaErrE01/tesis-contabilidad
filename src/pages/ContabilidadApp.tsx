...
export const ContabilidadApp = () => {
  ...
  return (
    <div id='inicio' className="h-screen">
      <h1
        className="lg:text-6xl text-orange-500 font-bold m-0 ml-10 lg:mt-10 sm:fixed lg:w-4/5 md:text-5xl md:w-full md:mt-20 text-4xl pt-8 sm:pt-0 leading-normal lg:leading-normal md:leading-normal"
      ...
      <div className="container mx-auto flex items-center sm:h-screen flex-col-reverse sm:flex-row md:mt-0 mt-10 gap-10 text-xl">
        <div className="basis-3/4 text-center flex justify-center items-center">
          <button
            className="lg:text-4xl text-orange-500 font-bold border-orange-500 border-solid border-2 rounded-full px-10 py-4 hover:bg-orange-500 hover:text-white transition-colors duration-300 ease-in-out md:text-2xl relative z-10 sm:px-8 sm:py-4"
            onClick={() => {
              navigate('/inicio');
            }}
          >
